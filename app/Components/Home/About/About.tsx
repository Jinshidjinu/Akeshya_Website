  ...
  return (
    <div>
        ...
        <div className='w-[90%] md:w-[80%] h-auto md:h-[240px] bg-white flex flex-col md:flex-row'>
          <div className='w-full md:w-[64%] h-full bg-white flex flex-col gap-7 text-[#444444] text-md p-5 md:p-0'>
            ...
            <ul className='flex flex-col gap-2'>
              <li className='list-item'><span><IoCheckmarkDoneSharp className='text-blue-900 text-lg' /></span> We started with a simple idea: do what is best for the client.</li>
              <li className='list-item'><span><IoCheckmarkDoneSharp className='text-blue-900 text-lg' /></span> Our methodical and individual approach to each project delivers the finest possible results for your media.</li>
              <li className='list-item'><span><IoCheckmarkDoneSharp className='text-blue-900 text-lg' /></span> Our day-to-day work is to solve your problems utilizing the most up-to-date, practical adaptive technology, and we have a lot of fun doing it.</li>
            </ul>
          </div>
      ...
      <div className='w-full md:w-[48%] h-[300px] md:h-[480px] bg-white flex justify-center md:justify-end'>
        <Image src="/Assets/counts-img.svg" alt='count-icon' width={530} height={300} className='object-contain' />
      </div>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
          <div className='flex items-center space-x-4'>
            ...
            <div className='flex flex-col'>
              <span className='numbers-align'>3835039</span>
          ...
          <div className='flex items-center space-x-4'>
            ...
            <div className='flex flex-col'>
              <span className='numbers-align'>85</span>
          ...
          <div className='flex items-center space-x-4'>
            ...
            <div className='flex flex-col'>
              <span className='numbers-align'>14081</span>
              <p className='text-sm font-semibold'>
          ...
          <div className='flex items-center space-x-4'>
            ...
            <div className='flex flex-col '>
              <span className='numbers-align '>17</span>
              <p className='text-sm font-semibold'>
